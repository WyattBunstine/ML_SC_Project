...
rsync -a --delete database/datafiles/MP/graphs_v4_doped_v45/ \
  wbunsti1@login.rockfish.jhu.edu:/data/tmcquee2/wbunsti1/ML_SC_Proj/database/datafiles/MP/graphs_v4_doped_v45/ && \
rsync -a database/datafiles/MP/SC_pack_doped_v45/ \
  wbunsti1@login.rockfish.jhu.edu:/scratch4/tmcquee2/wbunsti1/ML_SC_Proj/MP/SC_pack_doped_v45/ && \
rsync -a database/datafiles/MP/disorder_pack_v45/ \
  wbunsti1@login.rockfish.jhu.edu:/scratch4/tmcquee2/wbunsti1/ML_SC_Proj/MP/disorder_pack_v45/ && \
rsync -a database/datafiles/MP/dos_pack_ef1_v45/ \
  wbunsti1@login.rockfish.jhu.edu:/scratch4/tmcquee2/wbunsti1/ML_SC_Proj/MP/dos_pack_ef1_v45/ && \
