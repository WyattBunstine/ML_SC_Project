...
#   systemd-run --user ... bash -c './database/pipelines/supercon_expansion/supercon_v7_autopilot.sh >> model_data/cf_calib/supercon_v7.out 2>&1'
cd "$(dirname "$0")/../../.." || exit 1
B="python database/pipelines/supercon_expansion/build_supercon_v7.py"
