...
flag) for ranking and filtering.
  python database/pipelines/mp/build_mp_screen.py index      -> database/datafiles/MP/screen_mp_index.pickle + descriptors_screen_mp.pickle
  python database/pipelines/mp/build_mp_screen.py metadata   -> database/datafiles/MP/screen_mp_metadata.pickle
"""
import os
import sys
