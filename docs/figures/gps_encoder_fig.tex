% =====================================================================
%  GPSCrystalNet — geometry-aware crystal encoder (figure BODY)
% ---------------------------------------------------------------------
%  Preamble-free fragment: everything here (colors, styles, \fvec, the
%  tikzpicture) is legal in the document body, so this file can be
%  \input{} directly from the main paper inside a figure environment:
%
%     % main-doc preamble:
%     \usepackage{tikz}
...
%     \begin{figure*}[t]
%       \centering
%       \resizebox{\textwidth}{!}{\input{figures/gps_encoder_fig}}
%       \caption{...}\label{fig:gps-encoder}
%     \end{figure*}
%
%  For a standalone preview PDF, compile gps_encoder.tex (thin wrapper).
%
...
% \input of this fragment, already defined \fvec.
\providecommand{\fvec}[4]{%
  \foreach \k in {1,...,#3}{%
